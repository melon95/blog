---
title: React 哲学
description: React 开发实践和思考
date: "2024-04-19"
---



> 原文地址为 [react-philosophies](https://github.com/mithi/react-philosophies)
...
> 最好的代码就是无代码。每一行新的代码都需要被调试，需要被阅读和理解与支持
...
<details>
    <summary><em><strong>🙈  你真的需要它吗?</strong> 看看这些你可能不需要的依赖</em></summary>
